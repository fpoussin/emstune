...
InterrogateProgressView::InterrogateProgressView(QWidget *parent)
    : QWidget(parent)
{
    ui.setupUi(this);
...
void InterrogateProgressView::reset()
{
    ...
    ui.overviewTableWidget->item(0, 1)->setData(Qt::DisplayRole, QStringList() << "0"
                                                                               << "0");
    ...
    ui.overviewTableWidget->item(1, 1)->setData(Qt::DisplayRole, QStringList() << "0"
                                                                               << "0");
    ...
    ui.overviewTableWidget->item(2, 1)->setData(Qt::DisplayRole, QStringList() << "0"
                                                                               << "0");
